'''
This script comes from a final project in EECE5552 Assistive Robotics.
Project contact: Jake Ross
Developer of this code (not in Give a Hand): Daniel Pitsch

Related research paper: 
https://ieeexplore.ieee.org/document/6825822
'''
